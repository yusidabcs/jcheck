    ...
    <head>
        ...
        {{HTML::style('packages/bcscoder/jcheckout/css/jquery.noty.css')}}
            ...
            <div class="navbar navbar-fixed-top">
                <div class="navbar-inner">
                    <div class="container-fluid container-narrow">
                        <!-- start: Header Menu -->
                        <a class="brand hidden-phone" href="{{URL::to('')}}"><span style="font-size:14px;">{{$kontak->nama}}</span></a>
   ...
   <div id="cart_dialog" class="content_dialog" style="display:none"><img src="{{URL::to('img/spinner-mini.gif')}}" style="position:relative;margin:90% 10px 0px 10px"></div>            
    ...
    {{HTML::script("packages/bcscoder/jcheckout/js/jquery.noty.js")}}

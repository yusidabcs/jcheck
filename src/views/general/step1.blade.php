...
@endif
<div id="demos">
    <h1 class="text-center">Checkout - Rincian Belanja</h1>
    <hr>
    <div id="psteps_horiz_layout" class="pf-form">
        ...
        <div class="row-fluid box">
            <div class="span12 box-content" style="border:none">
                @if($cart->contents())
                {{Form::open(array('url'=>'mycheckout/pengiriman', 'method' => 'post','name'=>'checkout','id'=>'checkout','data-pjax'))}}
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr id="cart{{$item['rowid']}}">
                                <td class="hidden-phone"><div class="cart-img pull-left">{{HTML::image(get_upload_folder($akun).'/produk/thumb/'.$item['image'],'',array('width'=>'75px','height'=>'75px'))}}</div></td>
                                <td class="center">
                                ...
                                <td>{{ price_format($item['price'])}}</strong></td> 
                                <td>
                                    <span class="{{ $item['rowid'] }}"><strong>{{ price_format($item['price'] * $item['qty'])}}</strong></span>
                                </td>
                                <td><a onclick="deletecart({{ "'".$item['rowid']."'" }})" href="javascript:void(0);" class="tooltipme" data-toggle="tooltip" title="" data-original-title="Hapus?"><i class="icon-trash"></i></a></td>                                     
                            </tr>
                            @endforeach                                                            
                            <tr>
                                <td colspan="2"></td>
                                ...
                                <td colspan="2"><span class="price" id='subtotalcart'>{{price_format(Shpcart::cart()->total())}}</span></td>                             
                            </tr>
                            <tr>
                                <td colspan="2" ></td>
                                <td class="hidden-phone"></td>
                                ...
                                <td colspan="2"><span id='ekspedisitext'>{{$pengaturan->statusEkspedisi==2 ?'<strong>Free Shipping</strong>' : ($pengaturan->statusEkspedisi==3?'Pengiriman Menyusul':price_format($ekspedisi!=null?$ekspedisi['tarif']:0))}}</span></td>
                            </tr>
                            <tr>
                                <td colspan="2" ></td>
                                <td class="hidden-phone"></td>
                                ...
                                <td colspan="2"><span id='kupontext'>{{$diskon!=null?price_format($diskon['besarPotongan']):price_format(0)}}</span></td>               
                            </tr>    
                             <tr>
                                <td colspan="2"></td>
                                <td class="hidden-phone"></td>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><span id='kodeuniktext'>{{price_format($kodeunik)}}</td>                            
                            </tr> 
                            <tr class="success">
                                <td colspan="2"></td>
                                <td class="hidden-phone"></td>
                                ...
                                <td colspan="2"><h3><span id='totalcart'>
                                    {{price_format(Shpcart::cart()->total())}}</span></h3></td>                            
                            </tr>                                             
                        </tbody>
                    </table> 
                    <hr>
                     <div class="row-fluid">
                            <div class="span12">
                                <!-- <div style="text-align: right;">
                                     <button type="button" class="btn btn-link" name='kupondiskon' id="kupontanya" value="Pakai Kupon Diskon"><small>Punya Kupon ?</small></button>
                                     <hr>
                                </div> -->
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div id="diskonform" class="well">
                                            <h4>Kupon Diskon</h4>

                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td colspan="2"><h3><span id='dp'>
                                    {{jadiRupiah($dp*$jumlah)}}</span></h3></td>                            
                            </tr>         
                            ...
                            <tr class="success">
                                ...
                                <td class="hidden-phone"></td>
                                <td class="center">
                                    <h3>Total pembayaran pertama</h3>
                                </td> 
                                <td colspan="2"><h3><span id='totalawal'>
                                    {{jadiRupiah(($dp*$jumlah)+$kodeunik)}}</span></h3></td>                            
                            </tr>                                                
                        </tbody>
                    </table> 
                     <div class="row-fluid">

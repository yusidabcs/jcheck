	...
	<div id="psteps_horiz_layout" class="pf-form">
		<div class="row-fluid">
			<div class="span12">
				...
				<a href="{{URL::to('pembayaran')}}" ><div class="step-title btn "><span class="step-order">3.</span> <span class="step-name hidden-phone">Metode Pembayaran</span></div></a>
				...
				<div class="step-content">
					<table class="table table-bordered table-striped table-condensed">
						...
						<tbody>
							...
							<tr>
								<td colspan="4" style="text-align: right"><div class="item">DP :</div></td>
                                <td colspan="2">
                                    {{jadiRupiah($dp*$jumlah)}}
								</td>                            
                            </tr>         

                            <tr>
                            	<td colspan="4" style="text-align: right"><div class="item">Total pembayaran pertama :</div></td>
                                <td colspan="2">
                                    {{jadiRupiah($totaldp)}}
                                </td>                            
                            </tr>                               
